...
/* Spanish text resources */
  ...
  static Map<String, Map<String, String>> _localizedCompatibilityValues = {
    ...
    'en': {
      ...
      'progress': "Progress",
      'friends': "Friends",
      'international-travel': 'Travel to other countries',
      'do-sports': 'Do sport',
      'local-travel': 'Local trips',
      'cook': 'Cook',
      'new-restaurants': 'Got to new restaurants',
      'dancing': 'Go dancing',
      'stay-home': 'Watch movies and series at home',
      'go-for-drinks': 'Go out for drinks and talk',
      'art': 'Art',
    ...
    'es': {
      ...
      'progress': "Progreso",
      'friends': "Amigos",
      'international-travel': 'Viajar a otros paises',
      'do-sports': 'Hacer deporte',
      'local-travel': 'Viajes locales',
      'cook': 'Cocinar',
      'new-restaurants': 'Ir a nuevos restaurantes',
      'dancing': 'Salir a bailar',
      'stay-home': 'Ver peliculas y series en casa',
      'go-for-drinks': 'Salir y tomar unos tragos',
      'art': 'Arte',
